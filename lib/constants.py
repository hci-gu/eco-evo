...
SPECIES_MAP = {
    ...
    "cod": {
        ...
        "activity_metabolic_rate": 0.014535768421428572 * DAYS_PER_STEP * MULTIPLY_DEATH_RATE * 0.75,
        "standard_metabolic_rate": 0.0029071536857142857 * DAYS_PER_STEP * MULTIPLY_DEATH_RATE * 0.75,
        "max_consumption_rate": 0.0376 * DAYS_PER_STEP * EAT_REWARD_BOOST,
        "natural_mortality_rate": 0.003 * DAYS_PER_STEP * MULTIPLY_DEATH_RATE * 0.75,
        "fishing_mortality_rate": 0.005414 * DAYS_PER_STEP * SCALE_FISHING,
        "growth_rate": 0.03 * DAYS_PER_STEP * GROWTH_MULTIPLIER,
        "energy_cost": 0.25 * DAYS_PER_STEP,
